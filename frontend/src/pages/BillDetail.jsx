            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-blue-600 text-white">
                  ...
                  <th className="text-center px-4 py-3 font-semibold uppercase text-xs tracking-wider w-20">Qty</th>
                  <th className="text-right px-4 py-3 font-semibold uppercase text-xs tracking-wider w-32">Rate</th>
                  <th className="text-right px-4 py-3 font-semibold uppercase text-xs tracking-wider w-32">Amount</th>
                </tr>
              </thead>
              <tbody>
                {bill.items.map((it, i) => (
